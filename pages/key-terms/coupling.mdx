...
An app is made up of two parts: a <Link href="/key-terms/frontend">frontend</Link> and <Link href="/key-terms/backend">backend</Link>. The level at which those two parts are attached and dependent on each other describes how "coupled" they are.
