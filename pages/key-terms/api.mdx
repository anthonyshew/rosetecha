...
"API" is a really simple concept that gets used in all sorts of ways. A program that I write is most likely going to be interacting with the outside world so we need ways for our programs to communicate with each other. Those exposure points are the API.
