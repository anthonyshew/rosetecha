...
What some services will do is that they start out as <Link href="/key-terms/full-stack">full stack</Link>. But some devs don't want that service to be full stack. They only want half of it.
...
Remember, Wordpress has a <Link href="/key-terms/backend">backend</Link>. It has endpoints that I can use to manipulate and get data.
...
<Link href="/key-terms/coupling">Decoupling</Link> in action. What I've done is taken Wordpress and only used half of it. I'm going to use my Nextjs website and contact the Wordpress API when I need it.
