...
The frontend needs to be able to talk to the backend somehow. What the backend will have available for the backend is a bunch of these things called "endpoints."
