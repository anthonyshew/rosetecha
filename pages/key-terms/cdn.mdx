...
*Like...really fast.* Even if you understand how The Internet really works, it's still pretty unbelievable that the modern internet works - and is as fast as it is across the entire world.
...
Now, the next time someone in Germany asks for `cute-puppy-image.png`, the CDN will say "Hey, look, I have a version of that already here in Germany! I'll just give it to them from here since I'm only around the corner!"

Check that out. Now, you, in Germany, didn't have to visit California to get your cute puppy image. Instead, you got it from somewhere way closer to you.

That image will now load way quicker for you so you will have a better web experience.