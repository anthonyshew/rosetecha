...
Using <KeyTermLink termUrl="">git</KeyTermLink> as a base, developers can safely store their code (and the history of all its various versions) in the cloud where they can get to it from different computers and share it with others.
